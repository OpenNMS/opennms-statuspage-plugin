...
package org.opennms.statuspage.client.impl;
...
public class PDClientImpl implements PDClient {
    ...
    public CompletableFuture<Void> sendEvent(PDEvent event) {
        ...
        Request request = new Request.Builder()
                .url("https://events.statuspage.com/v2/enqueue")
        ...
        client.newCall(request)
                .enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) {
                        try {
                            // TODO: See https://developer.statuspage.com/docs/events-api-v2/overview/#api-response-codes--retry-logic
