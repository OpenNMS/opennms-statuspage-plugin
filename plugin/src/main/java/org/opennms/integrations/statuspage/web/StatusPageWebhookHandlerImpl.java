...
package org.opennms.integrations.statuspage.web;
...
import org.opennms.statuspage.webhook.Alert;
import org.opennms.statuspage.webhook.EventType;
import org.opennms.statuspage.webhook.Message;
import org.opennms.statuspage.webhook.Payload;
...
public class StatusPageWebhookHandlerImpl implements StatusPageWebhookHandler {
    private static final Logger LOG = LoggerFactory.getLogger(StatusPageWebhookHandlerImpl.class);
    ...
    public StatusPageWebhookHandlerImpl(AlarmDao alarmDao, EventForwarder eventForwarder) {
            ...
            if (EventType.ACKNOWLEDGE.equals(message.getEvent())) {
                for (Alert alert : message.getIncident().getAlerts()) {
                    ...
                    InMemoryEvent ackEvent = ImmutableInMemoryEvent.newBuilder()
                            ...
                            .setSource(StatusPageWebhookHandlerImpl.class.getCanonicalName())
                            .addParameter(ImmutableEventParameter.newInstance("ackType", "alarm"))
                            // FIXME: Derive user from payload
                            .addParameter(ImmutableEventParameter.newInstance("ackUser", "statusPagePlugin"))
