...
/**
 * Represents a statuspage notification to be sent at some future time, if the underlying alarm has not yet been
 * resolved.
 */
public class StatusPageForwarderTask implements Delayed {
    /**
    ...
    /**
     * The statuspage event to notify about.
     */
    private final PDEvent pdEvent;

    public StatusPageForwarderTask(Instant fireAfter, String reductionKey, PDEvent pdEvent) {
    ...
    public boolean equals(Object o) {
        ...
        StatusPageForwarderTask that = (StatusPageForwarderTask) o;
    ...
    public String toString() {
        return "statuspageForwarderTask{" +
                "fireAfter=" + fireAfter +
