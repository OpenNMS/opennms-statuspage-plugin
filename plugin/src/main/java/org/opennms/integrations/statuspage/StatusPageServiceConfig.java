...
public class StatusPageServiceConfig {
    private final String pid;
    private final String routingKey;
    private final String jexlFilter;
    private final Duration holdDownDelay;

    public StatusPageServiceConfig(String pid, String routingKey, String jexlFilter, Duration holdDownDelay) {
    ...
    public boolean equals(Object o) {
        ...
        StatusPageServiceConfig that = (StatusPageServiceConfig) o;
    ...
    public String toString() {
        return "statuspageServiceConfig{" +
                "pid='" + pid + '\'' +
